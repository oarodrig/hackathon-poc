...
function App() {
  ...
  useEffect(() => {
    async function configureSdk() {
      ...
      try {
        ...
        zoomSdk.getSupportedJsApis().then((val) => console.log(val));
        ...
        zoomSdk.onReaction((evt) => {
          console.log(evt);
        });
        zoomSdk.addEventListener("onFeedbackReaction", (evt) => {
          console.log("onFeedbackReaction event listener called");
          console.log(evt);
        });
        // zoomSdk.onFeedbackReaction((event) => {
        //   console.log("onFeedbackReaction handler called");
        //   console.log(event);
        // });
        // window.addEventListener("onFeedbackReaction", (evt) => {
        //   console.log("native onFeedbackReaction event listener called");
        //   console.log(evt);
        // });
      } catch (error) {
        console.log(error);
  ...
  const handleGetAttention = () => fetch("/api/zoomapp/attention");

  return (
    <div className="App">
      <button onClick={handleGetAttention}>
